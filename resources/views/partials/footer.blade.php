<footer class="my-0">
    ...
    <div class="container my-0">
        <div class="box-container">
            ...
            <div class="box-footer">
                <h5>Chi ha lavorato al progetto?</h5>
                <ul>
                    <li>
        ...
        <div class="nav-icon">
            <div class="box-icon">
                <span>
                    <a target="_blank" href="https://it-it.facebook.com/Deliveroo/">
                        <i id="icon-fb" class="fab fa-facebook"></i>
                    </a>
                </span>
                <span>
                    <a target="_blank" href="https://twitter.com/deliveroo_italy?lang=it">
                        <i id="icon-tw" class="fab fa-twitter"></i>
                    </a>
                </span>
                <span>
                    <a target="_blank" href="https://www.instagram.com/deliveroo/?hl=it">
